...
<body>
	...
	<a href="/TTSS03/AddNewTrainingMode.jsp" class="btn btn-success mt-2">Add
		New Training Mode +</a>
	...
	<script>
		...
		function deleteTraining(trainingModecode) {
			// Make an AJAX request to the delete endpoint
 
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteTrainingMode/" + trainingModecode,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingMode.jsp";
