   ...
   <script>
    $(document).ready(function () {
        ...
        $("#saveButton").click(function () {
            ...
            var modifiedUid = $("#id").val();
            var modifiedSessionCode = $("#sessionCode").val();
            var modifiedSessionName = $("#sessionName").val();
            var modifiedFromDate= $("#fromDate").val();
            var modifiedToDate = $("#toDate").val();
            ...
            $.ajax({
                ...
                url: "/TTSS03/api/session/updateTrainingSession/" + modifiedUid,
                data: {
                	sessionCode: modifiedSessionCode,
                ...
                success: function (response) {
                    ...
                    window.location.href = "/TTSS03/session_master.jsp";
