...
<form id="addSessionForm" onsubmit="return saveGroup()">
  ...
  <div class="container">
    ...
    <input type="text" id="trainingmode" placeholder="Enter trainingmode" required>
        ...
        $(document).ready(function() {
            function validateForm() {
                ...
                if (trainingMode.trim() === "") {
                    document.getElementById("trainingmode").innerHTML = "Training mode is required";
                    return false;
                } else {
                    document.getElementById("trainingmode").innerHTML = "";
                }
            ...
            window.saveGroup = function() {
                if (validateForm()) {
                    ...
                    $.ajax({
                        type : "POST",
                        url : "/TTSS03/api/create/trainingMode",
