...
<body>
	...
	<a href="/TTSS03/AddNewSession.jsp" class="btn btn-success mt-2">Add
		New Session +</a>
	...
	<script>
		...
		function deleteTraining(id) {
			...
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/session/deleteSession/" + id,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingSession.jsp";
