...
<form id="addSessionForm" onsubmit="return saveGroup()">
  ...
  <label for="coordinatorname">Venue Co-Ordinator Name:</label>
    <input type="text" id="coordinatorname" placeholder="Enter spell" required>
 
  <label for="coordinatormobile">Venue Co-Ordinator Mobile:</label>
    <input type="text" id="coordinatormobile" placeholder="Enter spell" required>
 
  <label for="coordinatoremail">Venue Co-Ordinator Email:</label>
    <input type="text" id="coordinatoremail" placeholder="Enter spell" required>
     ...
     function validateForm() {
      ...
      window.saveVenue = function () {
        if (validateForm()) {
          ...
          $.ajax({
            type: "POST",
            url: "/TTSS03/api/create/venue",
            contentType: "application/json",
            data: JSON.stringify(formData),
            success: function (response) {
              console.log(response);
              toastr.success("Venue saved successfully");
              window.location.href = "/TTSS03/VenueSetUp.jsp";
            },
