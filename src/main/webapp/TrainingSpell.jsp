...
<body>
	...
	<a href="/TTSS03/Add New Spell.jsp" class="btn btn-success mt-2">Add
		New Spell +</a>
	...
	<script>
		...
		function deleteTraining(spellcode) {
			// Make an AJAX request to the delete endpoint
 
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteSpell/" + spellcode,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingSpell.jsp";
