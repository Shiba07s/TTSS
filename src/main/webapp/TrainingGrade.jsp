...
<a href="/TTSS03/AddTrainingGrade.jsp" class="btn btn-success mt-2">Add
	...
	<div class="card mt-2" style="width: 100%;">
	   ...
	   <script>
		...
		function deleteTraining(gradeId) {
			// Make an AJAX request to the delete endpoint

			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteGrade/" + gradeId,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingGrade.jsp";
