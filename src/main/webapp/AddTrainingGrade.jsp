...
<form id="addSessionForm" onsubmit="return saveGroup()">
  ...
  <div class="container">
    ...
    <label for="grade-name">Training Grade Name:</label>
 ...
 <script>
        $(document).ready(function() {
            function validateForm() {
                ...
                if (attendgrade.trim() === "") {
                    document.getElementById("grade-name").innerHTML = "Training Grade is required";
                    return false;
                } else {
                    document.getElementById("grade-name").innerHTML = "";
                }
            ...
            window.saveGroup = function() {
                if (validateForm()) {
                    ...
                    $.ajax({
                        type : "POST",
                        url : "/TTSS03/api/grade/create",
                        contentType : "application/json",
                        data : JSON.stringify(formData),
                        success : function(response) {
                            console.log(response);
                            toastr.success("Training Grade saved successfully");
                            window.location.href = "/TTSS03/TrainingGrade.jsp";
                        },
