...
#admintid tbody tr:hover {
 ...
 #selfButton {
    ...
    #selfButton label {
        margin-right: 10px; /* Optional: Adjust spacing between radio buttons and labels */
    }
</style>
</head>
...
<body>
	...
	<script>
		...
		//     if (selectedCheckboxes.length > 0) {
		//         selectedCheckboxes.each(function () {
		//             var treasuryId = $(this).data('treasuryid');
		//             var refPlannerIds = $(this).data('ref_planner_id');
...
<body>
	...
	<div class="fixed-buttons">
        <button class="btn btn-primary" id="downloadButton" style="margin-left: 100%;">Download Excel</button>
    </div>
