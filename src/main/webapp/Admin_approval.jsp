    ...
    function fetchDataAndDownload(apiEndpoint, spreadsheetName) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                addDownloadButton(response, spreadsheetName);
            },
...
// 											+ "</td>");
							  ...
							  function addDownloadButton(data, spreadsheetName) {
							        // Check if the download button already exists and remove it
							        $("#downloadButton").remove();

							        // Create a button for downloading Excel
							        var downloadButton = $('<button class="btn btn-primary" id="downloadButton">Download Excel</button>');
							        downloadButton.on("click", function () {
							            downloadDataToExcel(data, spreadsheetName);
							        });

							        // Add the button to your page
							        $(".fixed-buttons").append(downloadButton);
							    }

							    function downloadDataToExcel(data, spreadsheetName) {
							        ...
							        XLSX.writeFile(wb, spreadsheetName.toLowerCase() + ".xlsx");
							    }
							});
...
<!-- 				<button class="btn btn-danger" onclick="rejectTraining()">Cancel</button> -->
				<button id="submitRejectButton" class="btn btn-danger" style="width:100px;"
