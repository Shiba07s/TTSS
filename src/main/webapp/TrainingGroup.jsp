...
<body>
	...
	<a href="/TTSS03/AddTrainingGroup.jsp" class="btn btn-success mt-2">Add
...
// 					<button class='btn btn-danger btn-sm' onclick='deleteTraining("+ training.group_id+ ")'>Delete</button></td>");
		...
		function deleteTraining(groupId) {
			// Make an AJAX request to the delete endpoint

			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteGroup/" + groupId,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingGroup.jsp";
