            ...
            if (selectedRowsData.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        // Check if the response is a string and contains the success message
                        if (typeof response === 'string' && response.includes('Data stored successfully')) {
                    ...
                    error: function (xhr, status, error) {
                      ...
                      //  alert('Error storing data: ' + error + ' - ' + xhr.responseText);
    ...
    <script>
		...
		function filterTableRows(searchText) {
			$("#admintid tbody tr").filter(
					function() {
						var treasuryid = $(this).find("td:eq(3)").text()
