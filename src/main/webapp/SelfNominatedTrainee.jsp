...
<body>
	<div class="fixed-buttons">
		<button class="btn btn-success" id="approveButton"
			onclick="nominateTraining()">NOMINATED</button>
		<button class="btn btn-primary" id="selfButton"
			onclick="selfTraining()">SELF</button>
	</div>
	<div class="maindiv">
		<div class="maindiv2">
	...
	<div class="content">
		<div class="formheading">
			...
			<button id="selfButton" class="btn btn-primary" ">Self</button>
			<button id="nominatedButton" class="btn btn-secondary">Nominated</button>
		</div>
