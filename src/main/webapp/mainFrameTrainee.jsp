...
<body>
	...
	<div id="navbar">
<!-- 		<a href="/TTSS03/Tdashboard.jsp" target="mainFrame">Dashboard</a>  -->
			<a href="/TTSS03/ApplyTraining.jsp" target="mainFrame">Apply Trainings</a>
		<a href="/TTSS03/MyTraining.jsp" target="mainFrame">My Trainings</a> 
		
	</div>

	<div id="content">
		<div id="iframeContainer">
			<iframe src="/TTSS03/ApplyTraining.jsp" name="mainFrame" id="mainFrame" style="width: 100%; height: 400px;"></iframe>
		</div>
	</div>
	<script>
 function logout() {
