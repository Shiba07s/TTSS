...
<body>
	...
	<a href="/TTSS03/AddNewStatus.jsp" class="btn btn-success mt-2">Add New
		Status +</a>
	...
	<script>
		...
		function deleteTraining(statuscode) {
			// Make an AJAX request to the delete endpoint
 
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteStatus/" + statuscode,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingStatus.jsp";
