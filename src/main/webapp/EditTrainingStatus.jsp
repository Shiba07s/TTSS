	...
	$(document)
			.ready(
					function() {
						...
						var statusname = getUrlParameter("statusname");
						var status = getUrlParameter("status");

						// Set initial values in the input fields
						$("#statuscode").val(statuscode);
						$("#tstatus").val(statusname);
						$("#status").val(status);
						...
						$("#saveButton")
								.click(
										function() {
											...
											var modifiedUid = $("#statuscode")
													.val();
											var modifiedTStatus = $("#tstatus")
													.val();
											...
											$
													.ajax({
														...
														url : "/TTSS03/api/updateTrainingStatus/"
																+ modifiedUid,
														data : {
														...
														success : function(
															...
															window.location.href = "/TTSS03/TrainingStatus.jsp";
...
<body>
	...
	<div>
		<label for="tstatus">Training Status:</label> <input type="text" id="tstatus">
	</div>
	<div>
