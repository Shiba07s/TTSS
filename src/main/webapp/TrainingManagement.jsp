...
<body>
	...
	<script>
		...
		function deleteTraining(management_code) {
			// Make an AJAX request to the delete endpoint
 
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/delete/management/" + management_code,
		...
		function editTraining(training) {
		    ...
		    var editUrl = "/TTSS03/EditTrainingManagement.jsp";
