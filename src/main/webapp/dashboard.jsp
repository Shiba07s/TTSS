...
<body>
	<div class="row">
		...
		<div class="col-md-6 containerr">
			<button onclick="firstApi()" class="card-link"
				style="background: none; border: none; padding: 0; font: inherit; cursor: pointer;">
				<div>
					<div class="card-body custom-card-body"
						style="background: linear-gradient(to top, #c6fc03, #c6fc03); color: white; float: right; margin-left: 120px;">
						<h3 class="card-title" style="position: absolute"> 
							 1st Level Approval</h3>
						<p id="rejectedCount" style="margin: 50px; font-size: 20px;"></p>
		...
		<div class="col-md-6 containerr">
			<button onclick="secondApi()" class="card-link"
				...
				<div>
					<div class="card-body custom-card-body"
						style="background: linear-gradient(to top, #11f0e8,#11f0e8); color: white; float: right; margin-right: 80px;">
	...
	<script>
		...
		function firstApi() {
			window.location.href = "/budget_mapping_utilisation.jsp";
		}
		function secondApi() {
