...
//			}
		 ...
		 public List<Map<String, Object>> findApprovedDataTeacherTrainingName(String tname ) {
			 return ViewMyTrainingsRepo.findApprovedTeachersOnTrainingName(tname);
		 }
...
//		 @Override
//		 public List<ViewMyTrainings> savemyTrainingsxyz(String treasuryid, String ref_planner_id, long venueid, String vcapacity) {
//		     List<Object[]> findTrainingDetails = ViewMyTrainingsRepo.findTrainingDetails(ref_planner_id, venueid, treasuryid);
//
//				
//				
...
//		            viewMyTrainings.setTstarttime((String) row[8]);
//		            viewMyTrainings.setTendtime((String) row[9]);
//		            viewMyTrainings.setVcapacity((String) row[11]);
//		            
//		            viewMyTrainings.setVaddress((String) row[10]);
//		            viewMyTrainings.setVid((long) row[12]);
//		            viewMyTrainings.setVcontact((String) row[14]+ " "+(String) row[13]);
//		            viewMyTrainings.setVname((String) row[15]);
//		            //viewMyTrainings.setVcontact((String) row[11]);
//		            viewMyTrainings.setMaplocation((String) row[16]);
...
//		            // Set other fields based on your query
//
//		            int appliedCount = ViewMyTrainingsRepo.countAppliedTrainings(ref_planner_id, venueid);
//		            int vcapacityInt = Integer.parseInt(vcapacity);
//		            if (appliedCount <= vcapacityInt) {
//		                // Venue capacity not exceeded, add the training to the list
//		                viewMyTrainingsList.add(viewMyTrainings);
//		                System.out.println("Added training to the list.");
//		            } else {
//		                System.out.println("Skipped training due to venue capacity exceeded.");
//		            }
//		        }
//
//		        List<ViewMyTrainings> savedTrainings = ViewMyTrainingsRepo.saveAll(viewMyTrainingsList);
//
...
//		     List<ViewMyTrainings> trainings = ViewMyTrainingsRepo.findByTreasuryIdAndRefPlannerId(treasuryId, refPlannerIds);
//
//		     for (ViewMyTrainings training : trainings) {
//		         int appliedCount = ViewMyTrainingsRepo.countAppliedTrainings(training.getRef_planner_id(), training.getVid());
//		         int venueCapacity = Integer.parseInt(training.getVcapacity());
//
//		         if (appliedCount >= venueCapacity) {
//		        	 System.out.println("Added training to the list.");
//			            } else {
//			                System.out.println("Skipped training due to venue capacity exceeded.");
//			            }
