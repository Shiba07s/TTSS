...
//    }
    ...
    public ResponseEntity<List<ViewMyTrainings>> processData123456(@RequestParam String treasuryId,@RequestParam String ref_planner_id,@RequestParam String venueid) {
